...
- `mac_address` (String) In NetBox 4.2+, this field is populated from the primary MAC address. Use `netbox_mac_address` with `primary = true` for reliable assignment.
