...
- **Tests:** `TestAccNetboxMACAddress_primaryVM`, `TestAccNetboxMACAddress_primaryDevice`, `TestAccNetboxInterface_macAddressExplicit`, `TestAccNetboxInterface_macAddressServerSideNoDrift`
